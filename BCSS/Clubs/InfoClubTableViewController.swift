...
class InfoClubTableViewController: UITableViewController, MFMailComposeViewControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        guard let context = try! persistenceManagers.context.fetch(Organization.fetchRequest()) as? [Organization]
            else { return }
    ...
    @IBAction func joinTapped(_ sender: Any) {
        ...
        let myClub = Organization(context: persistenceManagers.context)
